...
class ProgramaOperativo(models.Model):
    ...
    objetivos = models.CharField(max_length=1000,blank=True, null=True)
    estrategias = models.CharField(max_length=1000, blank=True, null=True)
    beneficiarios = models.CharField(max_length=1000, blank=True, null=True)
    justificacion = models.CharField(max_length=1000, blank=True, null=True)
    problematicaSocial = models.CharField(max_length=1000, blank=True, null=True)
